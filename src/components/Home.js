        ...
        <div className="container-fluid" >
                <div className="row">
                    <div className="col-md-5">
                        <h1 className="display-1 pt-5 ps-5 respo" style={{fontWeight: "bold" }}><span style={{ color: "#9C27B0" }}>i</span>Notebook</h1>
                        ...
                        <div className="d-flex justify-content-center">
                            <Button component={Link} to="/newnote" variant="contained" color="secondary" style={{ color: "White", textTransform: "none", fontFamily: "'Poppins', sans-serif", fontSize: "1.3rem" }}>Create New Note</Button>
                        </div>
                    </div>
